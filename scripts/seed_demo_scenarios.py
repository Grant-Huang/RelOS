...
NODES: list[dict] = [
    ...
    # ── 复杂场景A：半导体封装复合扰动 ────────────────────────────────
    {"id": "order-BGA-rush-500", "node_type": "CustomerOrder", "name": "大客户 BGA 插单 500 件",
     "properties": {"due_time": "2026-03-30T18:00:00+08:00", "priority": "rush", "customer": "客户A"}},
    {"id": "machine-SMT-02", "node_type": "Machine", "name": "SMT-02 贴片机",
     "properties": {"line_id": "line-BGA-1", "workshop": "封装车间", "effective_capacity_per_hour": 180}},
    {"id": "machine-SMT-04", "node_type": "Machine", "name": "SMT-04 贴片机",
     "properties": {"line_id": "line-BGA-1", "workshop": "封装车间", "effective_capacity_per_hour": 160}},
    {"id": "material-0402-resistor", "node_type": "MaterialLot", "name": "0402 电阻卷料",
     "properties": {"stock_hours_left": 1.5, "location": "封装库位A-04", "safety_stock_hours": 4}},
    {"id": "component-feeder-SMT02", "node_type": "Feeder", "name": "SMT-02 送料器",
     "properties": {"machine_id": "machine-SMT-02", "health_score": 0.42}},
    {"id": "process-BGA", "node_type": "Process", "name": "BGA 封装工序",
     "properties": {"line": "封装线1", "critical_to_order": True}},
    {"id": "supplier-electronics", "node_type": "Supplier", "name": "华芯电子物料中心",
     "properties": {"category": "阻容料", "expedite_capable": True, "lead_time_hours": 2.0}},

    # ── 复杂场景B：汽车零部件复合扰动 ───────────────────────────────
    {"id": "order-auto-A-500", "node_type": "CustomerOrder", "name": "大客户A精密壳体订单 500 件",
     "properties": {"due_time": "2026-03-30T16:00:00+08:00", "priority": "rush", "customer": "客户A"}},
    {"id": "machine-CNC-07", "node_type": "Machine", "name": "CNC-07 精密机床",
     "properties": {"workshop": "精密加工区", "role": "core_capacity", "vibration_state": "warning"}},
    {"id": "machine-CNC-09", "node_type": "Machine", "name": "CNC-09 精密机床",
     "properties": {"workshop": "精密加工区", "role": "backup_capacity", "available_hours": 6}},
    {"id": "machine-CNC-12", "node_type": "Machine", "name": "CNC-12 精密机床",
     "properties": {"workshop": "精密加工区", "role": "backup_capacity", "available_hours": 5}},
    {"id": "quality-BLine-CPK", "node_type": "QualityMetric", "name": "B线 CPK",
     "properties": {"current_value": 1.1, "control_limit": 1.33, "batch_count": 3}},
    {"id": "tool-phi32-mill", "node_type": "Tool", "name": "φ32 铣刀",
     "properties": {"stock_qty": 0, "critical_machine": "machine-CNC-12"}},
    {"id": "fixture-housing-A", "node_type": "Fixture", "name": "精密壳体夹具 A",
     "properties": {"compatible_machines": ["machine-CNC-09", "machine-CNC-12"]}},
    {"id": "process-housing", "node_type": "Process", "name": "精密壳体加工",
     "properties": {"critical_to_order": True, "product_family": "精密壳体"}},
]
...
RELATIONS: list[RelationObject] = [
    ...
    RelationObject(
        id="demo-rel-cs1-001",
        relation_type="ORDER__REQUIRES__CAPACITY",
        source_node_id="order-BGA-rush-500",
        source_node_type="CustomerOrder",
        target_node_id="process-BGA",
        target_node_type="Process",
        confidence=0.96,
        provenance=SourceType.MES_STRUCTURED,
        provenance_detail="ERP 插单需求：当日 18:00 前额外完成 500 件 BGA 封装",
        half_life_days=7,
        status=RelationStatus.ACTIVE,
        properties={"required_units": 500, "capacity_share_pct": 35},
    ),
    RelationObject(
        id="demo-rel-cs1-002",
        relation_type="MACHINE__SUPPORTS__PROCESS",
        source_node_id="machine-SMT-02",
        source_node_type="Machine",
        target_node_id="process-BGA",
        target_node_type="Process",
        confidence=0.93,
        provenance=SourceType.MES_STRUCTURED,
        provenance_detail="SMT-02 是 BGA 封装主力设备",
        half_life_days=365,
        status=RelationStatus.ACTIVE,
    ),
    RelationObject(
        id="demo-rel-cs1-003",
        relation_type="MACHINE__SUPPORTS__PROCESS",
        source_node_id="machine-SMT-04",
        source_node_type="Machine",
        target_node_id="process-BGA",
        target_node_type="Process",
        confidence=0.9,
        provenance=SourceType.MES_STRUCTURED,
        provenance_detail="SMT-04 可作为插单并行产能",
        half_life_days=365,
        status=RelationStatus.ACTIVE,
    ),
    RelationObject(
        id="demo-rel-cs1-004",
        relation_type="MACHINE__SHOWS__ANOMALY",
        source_node_id="machine-SMT-02",
        source_node_type="Machine",
        target_node_id="component-feeder-SMT02",
        target_node_type="Feeder",
        confidence=0.84,
        provenance=SourceType.SENSOR_REALTIME,
        provenance_detail="SMT-02 贴装偏移量接近工艺上限 80%",
        half_life_days=7,
        status=RelationStatus.ACTIVE,
        properties={"offset_ratio": 0.8},
    ),
    RelationObject(
        id="demo-rel-cs1-005",
        relation_type="MATERIAL__DEPLETES__PROCESS",
        source_node_id="material-0402-resistor",
        source_node_type="MaterialLot",
        target_node_id="process-BGA",
        target_node_type="Process",
        confidence=0.89,
        provenance=SourceType.MES_STRUCTURED,
        provenance_detail="SMT-02 所需 0402 电阻卷料仅余 1.5 小时用量",
        half_life_days=3,
        status=RelationStatus.ACTIVE,
        properties={"stock_hours_left": 1.5},
    ),
    RelationObject(
        id="demo-rel-cs1-006",
        relation_type="SUPPLIER__SUPPORTS__MATERIAL",
        source_node_id="supplier-electronics",
        source_node_type="Supplier",
        target_node_id="material-0402-resistor",
        target_node_type="MaterialLot",
        confidence=0.78,
        provenance=SourceType.MES_STRUCTURED,
        provenance_detail="备料可于 15:00 到位，路径可行",
        half_life_days=14,
        status=RelationStatus.ACTIVE,
        properties={"eta": "2026-03-30T15:00:00+08:00"},
    ),
    RelationObject(
        id="demo-rel-cs1-007",
        relation_type="MACHINE__CAUSES__QUALITY_RISK",
        source_node_id="machine-SMT-02",
        source_node_type="Machine",
        target_node_id="process-BGA",
        target_node_type="Process",
        confidence=0.76,
        provenance=SourceType.LLM_EXTRACTED,
        provenance_detail="历史故障模式显示送料器齿轮磨损与贴装偏移高度匹配",
        half_life_days=30,
        status=RelationStatus.PENDING_REVIEW,
        properties={"likely_root_cause": "feeder_gear_wear"},
    ),
    ...
    RelationObject(
        id="demo-rel-cs2-001",
        relation_type="ORDER__REQUIRES__CAPACITY",
        source_node_id="order-auto-A-500",
        source_node_type="CustomerOrder",
        target_node_id="process-housing",
        target_node_type="Process",
        confidence=0.95,
        provenance=SourceType.MES_STRUCTURED,
        provenance_detail="客户 A 要求当日 16:00 前完成 500 件精密壳体加工",
        half_life_days=7,
        status=RelationStatus.ACTIVE,
        properties={"required_units": 500},
    ),
    RelationObject(
        id="demo-rel-cs2-002",
        relation_type="MACHINE__SUPPORTS__PROCESS",
        source_node_id="machine-CNC-07",
        source_node_type="Machine",
        target_node_id="process-housing",
        target_node_type="Process",
        confidence=0.94,
        provenance=SourceType.MES_STRUCTURED,
        provenance_detail="CNC-07 为精密壳体加工核心设备",
        half_life_days=365,
        status=RelationStatus.ACTIVE,
    ),
    RelationObject(
        ...
        source_node_id="machine-CNC-07",
        source_node_type="Machine",
        target_node_id="quality-BLine-CPK",
        target_node_type="QualityMetric",
        confidence=0.83,
        provenance=SourceType.SENSOR_REALTIME,
        provenance_detail="CNC-07 发出振动异常预警，疑似主轴轴承早期磨损",
        half_life_days=7,
        status=RelationStatus.ACTIVE,
        properties={"vibration_state": "warning"},
    ),
    RelationObject(
        id="demo-rel-cs2-004",
        relation_type="MACHINE__IMPACTS__QUALITY",
        source_node_id="machine-CNC-07",
        source_node_type="Machine",
        target_node_id="quality-BLine-CPK",
        target_node_type="QualityMetric",
        confidence=0.81,
        provenance=SourceType.INFERENCE,
        provenance_detail="历史图谱中 CNC-07 与 B线 CPK 下滑存在时序关联",
        half_life_days=14,
        status=RelationStatus.ACTIVE,
        properties={"cpk_value": 1.1},
    ),
    RelationObject(
        id="demo-rel-cs2-005",
        relation_type="QUALITY__CONSTRAINS__SCHEDULE",
        source_node_id="quality-BLine-CPK",
        source_node_type="QualityMetric",
        target_node_id="order-auto-A-500",
        target_node_type="CustomerOrder",
        confidence=0.74,
        provenance=SourceType.INFERENCE,
        provenance_detail="连续 3 个批次 CPK 下降至 1.1，限制继续放大排产",
        half_life_days=7,
        status=RelationStatus.ACTIVE,
        properties={"batch_count": 3},
    ),
    RelationObject(
        id="demo-rel-cs2-006",
        relation_type="RESOURCE__REQUIRES__MRO_ITEM",
        source_node_id="machine-CNC-12",
        source_node_type="Machine",
        target_node_id="tool-phi32-mill",
        target_node_type="Tool",
        confidence=0.88,
        provenance=SourceType.MES_STRUCTURED,
        provenance_detail="CNC-12 缺少 φ32 铣刀，库存 0 件",
        half_life_days=7,
        status=RelationStatus.ACTIVE,
        properties={"stock_qty": 0},
    ),
    RelationObject(
        id="demo-rel-cs2-007",
        relation_type="MACHINE__REQUIRES__FIXTURE",
        source_node_id="machine-CNC-12",
        source_node_type="Machine",
        target_node_id="fixture-housing-A",
        target_node_type="Fixture",
        confidence=0.79,
        provenance=SourceType.MES_STRUCTURED,
        provenance_detail="精密壳体工序切换需夹具 A",
        half_life_days=30,
        status=RelationStatus.ACTIVE,
    ),
]
...
async def seed_demo() -> None:
    ...
    print("   复杂场景 → POST /v1/scenarios/composite-disturbance/analyze")
